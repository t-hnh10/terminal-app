...
def get_questions(how_many)
   questions = [
      ...
      GeoQuestion.new("On which continent upright-walking ancestors originate?",
         ["a) Russia", "b) Asia","c)Russia", "d) Africa"],"d"),
       
      GeoQuestion.new("How any alternating red and white stripes does the American Flag have?",
         ["a) 13", "b) 11", "c) 16 ", "d) 9"], "a"),
      
      GeoQuestion.new("How sewed the Famous Eureka Flag?",
      ...
      GeoQuestion.new("How many rivers in Russia?",
         ["a) 200", "b) 40 000", "c) 100 000", "d) 12000"],"c"),
      
      GeoQuestion.new("Where is Hulun Lake situated?",
         ["a) Hong Kong", "b) China", "c) Taiwan", "d) Mongolia"], "d"),
      ...
      GeoQuestion.new("Which Continent is the Great Bear Lake",
         ["a) Russia", "b) North America ", "c) Asia", "d) South America"], "b"),
      
      GeoQuestion.new("Which US city has the largest population of Polish?",
      ...
      GeoQuestion.new("Which is the world's largest continent?",
      ...
      GeoQuestion.new("What country has the most natural lakes?", 
         ["a) Australia", "b) India", "c) United State", "d) Canada"], "d"),
      ...
      GeoQuestion.new("What continent in located at latitude 90 degrees south Longitude 0.00 degrees east?",
         ["a) Asia" "b) Australia", "c) Antarctica", "d) South America"], "c"),
      
      GeoQuestion.new("What is the larges country in South America?",
      ...
      GeoQuestion.new("What is western most and eastern most states in the United States?",
      ...
      GeoQuestion.new("What is the capital of Turkey?",
         ["a) Istanbul", "b) Izmar", "c) Ankara", "d) Bursa"], "c"),
